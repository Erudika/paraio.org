...
<table class="table table-striped">
	...
	<tbody>
		...
		<tr><td>`para.ms_app_id`						</td><td>-</td></tr>
		...
		<tr><td>`para.shared_table_name`		</td><td>`0`</td></tr>
		<tr><td>The name of the table which is shared by apps with `isSharingTable` set to `true`. </td><td></td></tr>
		<tr><td>`para.prepend_shared_appids_with_space`		</td><td>`false`</td></tr>
		...
		<tr><td>`para.security.protected.{name}`		</td><td> - </td></tr>
		...
		<tr><td>`para.logs_dir`	</td><td> `.` </td></tr>
